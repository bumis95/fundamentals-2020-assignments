...
//        adapter.notifyDataSetChanged()
        ...
        val originalData = ActorsDataSource().getActors()
        val shuffledData = ActorsDataSource().getActors().shuffled()
        adapter.bindActors(shuffledData)
        /* Update adapter */
        val diffCallback = ActorDiffUtilCallback(originalData, shuffledData)
